...
# Record the results
performanceArr = np.array([iSet,testError,testAccuracy],dtype=np.float32)
...
subprocess.call("mv" + OUT_DIR + "/*.meta " + OUT_DIR + "*.index " + OUT_DIR + "*.data* " + OUT_DIR + "checkpoint " + OUT_DIR + "/models/")
